...
def get_premiere_keyboard():
    premier_buttons = list(map(lambda x: InlineKeyboardButton(text=x['nameRu'], callback_data=f'premier-movie-button:{x['kinopoiskId']}'), MovieService.get_premier_movies('MARCH', 2025)['items']))
